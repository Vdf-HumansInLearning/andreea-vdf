let articles = [
    {
        ...
        imgUrl : "img/bike.jpg",
        imgAlt : "Bike",
        content : [`Lorem ipsum dolor sit amet consectetur, adipisicing elit. Est totam laboriosam debitis magnam
        voluptatum,
        ...
        consequuntur
        repellendus ipsum temporibus libero itaque. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Est totam laboriosam debitis magnam
        voluptatum,
        incidunt neque. Totam ullam non quis, repellendus molestiae in itaque natus labore quos ipsum
        alias,
        veritatis nihil! Quisquam labore, sequi minima expedita necessitatibus omnis error amet
        ...
        atque commodi quia! Vel laborum recusandae voluptatum rerum id harum, fuga beatae ut,
        consequuntur
        repellendus ipsum temporibus libero itaque.`, `Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde quod tempore quaerat deserunt.
        Voluptatibus
        ...
        Nisi
        facilis voluptatem omnis debitis laborum cupiditate pariatur inventore molestiae eveniet! Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde quod tempore quaerat deserunt.
        Voluptatibus
        possimus, magni quas rem adipisci, esse ipsa fuga, fugit eos repellendus quis? Dicta
        perferendis,
        doloremque provident repellendus natus fugit obcaecati, voluptate odio, nulla similique officia.
        ...
        velit suscipit amet tenetur, mollitia aut dolor ipsa delectus a autem ut quibusdam incidunt?
        Nisi
        facilis voluptatem omnis debitis laborum cupiditate pariatur inventore molestiae eveniet!`],
    ...
    },
    {
        ...
        Nisi
        facilis voluptatem omnis debitis laborum cupiditate pariatur inventore molestiae eveniet!`],
        saying : "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur, maxime?"
    },
    {
        id: 3,
...
function createNav(){
    ...
    for(let i=0; i<navLinks.length; i++){
        ...
        navAnchor.setAttribute("href","/#home");
...
function createArticleHome(article) {
    ...
    readMoreLink.setAttribute("href",`/#article?id=${article.id}`);
...
function createFooterDetails() {
    ...
    if(id > 1) {
        ...
        prevLink.setAttribute("href",`/#article?id=${id - 1}`);
    ...
    if(id < articles.length) {
        ...
        nextLink.setAttribute("href",`/#article?id=${id + 1}`);
...
function createModal() {
    let inputs = ["Please enter title", "Please enter tag", "Please enter author", "Please enter date", "Please enter image url", "Please enter saying"];
